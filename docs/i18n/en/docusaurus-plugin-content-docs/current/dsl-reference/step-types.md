...
- `shell` (optional): `array` of `string` - Shell configuration for this step. Overrides workflow's global `shell`. See [Shell configuration](/docs/dsl-reference/shell) for details and examples.
